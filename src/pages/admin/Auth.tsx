  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!roles.includes("admin")) {
        ...
        throw new Error("Accesso non autorizzato. Questo portale è riservato agli amministratori.");
      }
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f9] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="flex justify-center mb-6">
        <div className="w-16 h-16 rounded-xl bg-[#dc2626] flex items-center justify-center shadow-lg">
      ...
      <Card className="w-full max-w-md border-[#e1e8ed] shadow-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl text-[#2c3e50]">Accesso Admin</CardTitle>
      ...
      <p className="text-center text-xs text-[#7f8c9a] mt-6">
        Accesso riservato. Tentativi non autorizzati verranno registrati.
      </p>
    </div>
  );
};
